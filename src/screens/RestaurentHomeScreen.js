...
const RestaurentHomeScreen = ({navigation,route}) => {
  ...
  return (
        <View style={styles.container}>
              <ScrollView>
                    <View>
                          <RestaurentHeader id={id} navigation={navigation} />
                          ...
                          <View style={styles.view2}>
                                <View style={styles.view3}>
                                      ...
                                      <View style={styles.view4}>
                                            <Icon name='star' type='material-community' color={colors.gray3} size={15} />   
                                            ...
                                            <Icon name='map-marker' type='material-community' color={colors.gray3} size={15} />   
                                             <Text style={styles.text6}>{restaurantsData[id].farAway}km away</Text>
                                   </View>
                                </View>
